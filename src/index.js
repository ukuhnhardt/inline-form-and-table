            ...
            <div id="detail-panel">
              ...
              <div className="details-content">
                ...
                <p>
                  <em>Type</em>:{" "}
                  {
                    this.state.data.find(el => el.id === this.state.showDetails)
                      .type
                  }
                </p>
                <p>
                ...
                <p>
                  ...
                  Mi ipsum faucibus vitae aliquet. Viverra maecenas accumsan
                  lacus vel facilisis volutpat est velit egestas. Cras pulvinar
                  mattis nunc sed blandit. Nulla malesuada pellentesque elit
                  eget. Egestas sed tempus urna et pharetra pharetra massa massa
                  ultricies. Tellus orci ac auctor augue mauris. Phasellus
                  egestas tellus rutrum tellus pellentesque eu. Aliquam ut
                  porttitor leo a diam sollicitudin. Aliquam sem et tortor
                  consequat. Scelerisque purus semper eget duis at tellus at
                  urna condimentum.{" "}
                </p>
              </div>
            </div>
